...
public interface IProjectionRepository
{
    ...
    Task<List<Dictionary<string, object?>>> Query(ProjectionQuery projectionQuery, string? partitionKey = null, CancellationToken cancellationToken = default);
    ...
    where TDocument : ProjectionDocument
{
    ...
    new Task<List<TDocument>> Query(ProjectionQuery projectionQuery, string? partitionKey = null, CancellationToken cancellationToken = default);
