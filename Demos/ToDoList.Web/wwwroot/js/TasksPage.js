(function () {
    class ToDoList {
        constructor(rootContainer, draggableSelector, horizontal = false) {
        ...
        dragOverEventHandler(e) {
            ...
            console.debug('Dragleave queue length: ', this.dragLeaveQueue.length);
            ...
            if(this.horizontal){
                ...
                const left = e.offsetX < (targetWidth / 2);
                ...
                const sourceHeight = this.draggable.getBoundingClientRect().height;
                const targetHeight = target.getBoundingClientRect().height;

                const above = targetHeight / 2 > e.offsetY;
                ...
                this.lastDraggedOverAbove = above;
            }
    ...
    window.ToDoList = {
        initializeTaskDragAndDrop: function (container, draggableSelector, horizontal) {
            new ToDoList(container, draggableSelector, horizontal);
        }
    };
})();